...
public class ServerEditorActivity$$SharedPreferenceInjector<T extends com.diamondstudio.tweaks.ServerEditorActivity> implements Injector<T> {
    ...
    private void initializeTarget(T target, SharedPreferences prefs) {
        if (prefs.contains("key_server_url")) {
            ...
            target.mServerUrl = key_server_url;
        }
